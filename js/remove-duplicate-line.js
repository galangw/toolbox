...
removeDuplicates.addEventListener("click", function() {
    ...
    if (removeEmpty == true && totalEmptyRemoved > 0) {
        ...
        totalRemovedText.innerHTML = "There was a total of <strong>" + totalRemoved +
            "</strong> duplicates and <strong>" + totalEmptyRemoved + "</strong> empty lines removed.";
    } else {
        totalRemoved = data.length - result.length;
        totalRemovedText.innerHTML = "There was a total of <strong>" + totalRemoved +
            "</strong> duplicates removed.";
    }
...
saveFile.addEventListener("click", function() {
    var textToSaveAsBlob = new Blob([textArea.value], {
        type: "text/plain"
    });
